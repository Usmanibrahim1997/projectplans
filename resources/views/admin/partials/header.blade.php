...
@php
    ...
    $materials = \DB::table('com_list')->count();
@endphp
      ...
      <div class="card mb-3 widget-content">
        <div class="widget-content-outer">
          <div class="widget-content-wrapper">
            ...
            <div class="widget-content-right">
              <div class="widget-numbers text-success ml-3"><span style="font-size:35px">{{ $totalCompany ?? "0" }}</span></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card mb-3 widget-content">
        <div class="widget-content-outer">
          <div class="widget-content-wrapper">
            ...
            <div class="widget-content-right">
              <div class="widget-numbers text-warning ml-3"><span style="font-size:35px">{{ $materials ?? "0" }}</span></div>
            </div>
          </div>
        </div>
      </div>
