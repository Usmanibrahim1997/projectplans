    ...
    <div class="scrollbar-sidebar">
      <div class="app-sidebar__inner">
        <ul class="vertical-nav-menu">
          ...
          <li>
            <a href="#"><i class="metismenu-icon pe-7s-users"></i> Users</a>
            <ul>
              <li><a href="#" ><i class="metismenu-icon"></i> Add User</a></li>
              <li><a href="{{ route('user_list') }}"><i class="metismenu-icon"></i> User List</a></li>
            </ul>
          </li>
          <li>
            <a href="#"><i class="metismenu-icon pe-7s-note"></i> Projects</a>
            <ul>
              <li><a href="{{ route('project_form') }}"><i class="metismenu-icon"></i> Add Project</a></li>
              <li><a href="{{ route('show_project_list') }}"><i class="metismenu-icon"></i> Project List</a></li>
            </ul>
          </li>
          <li>
